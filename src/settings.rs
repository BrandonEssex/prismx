...
static THEME_INDEX: std::sync::atomic::AtomicU8 = std::sync::atomic::AtomicU8::new(0);
...
// Public re-exports for other modules
pub use self::{SETTING_TOGGLES, SettingToggle, settings_len};
