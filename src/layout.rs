...
/// Recursively assigns (x, y) positions to nodes based on their tree depth
pub fn layout_nodes(
    nodes: &NodeMap,
    root_id: NodeID,
    start_x: u16,
...
/// Internal helper for recursive layout
fn layout_recursive(
    nodes: &NodeMap,
    node_id: NodeID,
    x: u16,
    ...
    for child_id in &node.children {
        current_y = layout_recursive(nodes, *child_id, x + 3, current_y, out) + 1;
    }
